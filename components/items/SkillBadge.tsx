...
export const SkillBadge = ({ skillName, position }: SkillBadgeProps): JSX.Element => {
  ...
  switch (skillName) {
    ...
    case 'Git Actions':
      ...
      break;
    case 'Confluence':
      iconUrl = './images/skillIcons/collaboration-tools/confluence.svg';
      break;
    case 'Github':
      iconUrl = './images/skillIcons/collaboration-tools/github.svg';
      break;
    case 'MS Teams':
      iconUrl = './images/skillIcons/collaboration-tools/ms-teams.svg';
      break;
    case 'Trello':
      iconUrl = './images/skillIcons/collaboration-tools/trello.svg';
      break;
    case 'Jira':
      iconUrl = './images/skillIcons/collaboration-tools/jira.svg';
      break;
  }
  if (iconUrl)
    return (
